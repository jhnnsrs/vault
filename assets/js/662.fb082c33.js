...
function validateQuery(ast, schema = null, customRules, isRelayCompatMode) {
  ...
  const deprecationWarningAnnotations = mapCat((0,graphql__WEBPACK_IMPORTED_MODULE_22__/* .validate */ .Gu)(schema, ast, [graphql__WEBPACK_IMPORTED_MODULE_26__/* .NoDeprecatedCustomRule */ .r]), (error) => annotations(error, DIAGNOSTIC_SEVERITY.Warning, "Deprecation"));
