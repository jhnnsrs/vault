...
module.exports = {
  someSidebar: {
    ...
    Basics: ['automation',"data","tasks"],
    Concepts: ['streams', 'nana',"immu","ressources","ele/graphql","ele/dashboard","macro"],
    Macros: ['macros/show_image', 'macros/time_lapse_color_coder'],
    Programming: ['async'],
